...
<h1 class="mb-3 p-5 text-center">{{ $title }}</h1>
  ...
  <div class="col-md-6">
    <form action="/posts">
      ...
      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Search.." name="search" value="{{ request('serach') }}"> 
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="position-absolute-center px-3 py-2 " style="background-color: rgba(0, 0, 0, 0.5)"><a href="/posts?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
                @if ($post->image)
